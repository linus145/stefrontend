...
export default async function BlogDetailPage({ params }: BlogPageProps) {
  ...
  return (
    <div className="bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen font-sans selection:bg-indigo-100 transition-colors duration-300 relative">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <header className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              <span className="px-3 py-1 bg-indigo-50 dark:bg-indigo-950/30 text-indigo-600 dark:text-indigo-400 text-xs font-bold rounded-full border border-indigo-100 dark:border-indigo-900/50 uppercase tracking-wider">
                {blog.category}
              </span>
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 dark:text-slate-50 mb-8 leading-[1.1] transition-colors duration-300">
              {blog.title}
            </h1>

            <div className="flex flex-wrap items-center gap-6 pb-12 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center text-slate-500 dark:text-slate-400">
                  <User className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-sm font-bold text-slate-900 dark:text-slate-50">{blog.author}</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Industry Expert</p>
                </div>
              </div>
          ...
          <article className="prose prose-slate prose-lg max-w-none">
            <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed font-medium mb-10 italic border-l-4 border-indigo-500 pl-6 transition-colors duration-300">
              {blog.excerpt}
            </p>
            
            <div className="text-slate-800 dark:text-slate-200 leading-[1.8] space-y-6 transition-colors duration-300">
