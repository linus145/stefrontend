        ...
        <section className="py-24 px-6 bg-slate-50 border-b border-slate-200/80 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              {/* Product Card 1: Interview Pipeline */}
                ...
                <div>
                  <div className="flex items-center gap-6 mb-6 border-t border-slate-100 pt-6">
                    <div>
                      ...
                      <span className="text-xs font-semibold text-slate-700">AI Screenings & Transcripts</span>
                    </div>
                    <div className="w-px h-8 bg-slate-150" />
                    <div>
                      <span className="text-[10px] text-slate-400 font-bold uppercase block">Features</span>
                      <span className="text-xs font-semibold text-slate-700">Typewriter streams & JSON Logs</span>
                    </div>
                  </div>

                  <Link href="/interview" className="block w-full">
                    <Button className="w-full h-11 rounded-xl bg-indigo-600 text-white font-semibold shadow hover:bg-indigo-500 hover:-translate-y-0.5 transition-all duration-200">
              ...
              <div className="bg-white border border-slate-200/60 rounded-3xl p-8 hover:shadow-xl hover:border-purple-200 hover:-translate-y-1 transition-all duration-300 shadow-sm relative overflow-hidden group flex flex-col justify-between">
                ...
                <div>
                  <div className="flex items-center gap-6 mb-6 border-t border-slate-100 pt-6">
                    <div>
                      <span className="text-[10px] text-slate-400 font-bold uppercase block">Core Module</span>
                      <span className="text-xs font-semibold text-slate-700">Attendance Sync & Shifts</span>
                    </div>
                    <div className="w-px h-8 bg-slate-150" />
                    <div>
                      <span className="text-[10px] text-slate-400 font-bold uppercase block">Features</span>
                      <span className="text-xs font-semibold text-slate-700">Admin controls & Scoping</span>
                    </div>
                  </div>

                  <Link href="/Hrtools" className="block w-full">
                    <Button variant="outline" className="w-full h-11 rounded-xl border-purple-200 text-purple-700 hover:bg-purple-50 hover:text-purple-800 hover:-translate-y-0.5 transition-all duration-200 font-semibold">
                      Enter HR Dashboard
                    </Button>
                  </Link>
                </div>
