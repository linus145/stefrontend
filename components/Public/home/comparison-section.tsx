    ...
    <section className="py-24 px-6 bg-white dark:bg-slate-950 border-y border-slate-200/80 dark:border-slate-800 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200/80 dark:border-slate-800 p-8 rounded-sm relative hover:shadow-md transition-all duration-300">
            <h3 className="text-sm font-semibold text-slate-400 dark:text-slate-500 mb-6 uppercase tracking-widest">Traditional ATS Pipelines</h3>
          ...
          <div className="bg-white dark:bg-slate-900 border-2 border-indigo-500/20 dark:border-indigo-500/30 shadow-lg p-8 rounded-sm relative hover:shadow-xl hover:border-indigo-500/40 transition-all duration-300 ring-4 ring-indigo-50/50 dark:ring-indigo-950/20">
            ...
            <h3 className="text-sm font-semibold text-indigo-600 dark:text-indigo-400 mb-6 uppercase tracking-widest">B2Linq Autonomous OS</h3>
