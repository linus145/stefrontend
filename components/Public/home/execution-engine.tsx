      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
        ...
        <div className="lg:col-span-5 space-y-12">
          <div className="space-y-4">
            <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-white leading-tight">The execution engine.</h2>
          ...
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-800 before:to-transparent">
            ...
            <div className="relative flex items-start gap-6 group">
              <div className="z-10 flex items-center justify-center w-10 h-10 rounded-sm bg-slate-950 border border-slate-800 text-indigo-400 font-bold text-sm shrink-0 transition-colors duration-300 group-hover:border-indigo-500">1</div>
              <div>
                <h4 className="text-lg font-semibold text-white mb-1">Apply & Analyze</h4>
            ...
            <div className="relative flex items-start gap-6 group">
              <div className="z-10 flex items-center justify-center w-10 h-10 rounded-sm bg-slate-950 border border-slate-800 text-indigo-400 font-bold text-sm shrink-0 transition-colors duration-300 group-hover:border-indigo-500">2</div>
              <div>
                <h4 className="text-lg font-semibold text-white mb-1">Screen & Interview</h4>
            ...
            <div className="relative flex items-start gap-6 group">
              <div className="z-10 flex items-center justify-center w-10 h-10 rounded-sm bg-slate-950 border border-slate-800 text-indigo-400 font-bold text-sm shrink-0 transition-colors duration-300 group-hover:border-indigo-500">3</div>
              <div>
                <h4 className="text-lg font-semibold text-white mb-1">Review & Hire</h4>
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-slate-950 border border-slate-800/80 p-6 rounded-sm hover:border-indigo-500/40 hover:-translate-y-0.5 transition-all duration-300">
            <div className="h-10 w-10 rounded-sm bg-indigo-500/10 flex items-center justify-center mb-4">
              <Video className="w-5 h-5 text-indigo-400" />
            </div>
            <h4 className="text-white font-semibold mb-2">AI Voice Interviews</h4>
          ...
          <div className="bg-slate-950 border border-slate-800/80 p-6 rounded-sm hover:border-indigo-500/40 hover:-translate-y-0.5 transition-all duration-300">
            <div className="h-10 w-10 rounded-sm bg-purple-500/10 flex items-center justify-center mb-4">
              <Layers className="w-5 h-5 text-purple-400" />
            </div>
            <h4 className="text-white font-semibold mb-2">Recruiter Workspace</h4>
          ...
          <div className="bg-slate-950 border border-slate-800/80 p-6 rounded-sm hover:border-indigo-500/40 hover:-translate-y-0.5 transition-all duration-300">
            <div className="h-10 w-10 rounded-sm bg-emerald-500/10 flex items-center justify-center mb-4">
          ...
          <div className="bg-slate-950 border border-slate-800/80 p-6 rounded-sm hover:border-indigo-500/40 hover:-translate-y-0.5 transition-all duration-300">
            ...
            <h4 className="text-white font-semibold mb-2">HR Intelligence</h4>
