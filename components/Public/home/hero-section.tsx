...
export function HeroSection() {
  return (
    <section className="relative pt-36 sm:pt-40 lg:pt-48 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center flex flex-col items-center">
      ...
      <h1 className="text-4xl sm:text-6xl lg:text-[72px] font-extrabold tracking-tight text-slate-900 dark:text-slate-50 mb-6 leading-[1.05] max-w-4xl transition-colors duration-300">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto mb-16">
        ...
        <Link href="#interactive-flow" className="w-full sm:w-auto">
          <Button variant="outline" className="w-full sm:w-auto h-13 px-8 rounded-xl border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-100 transition-all font-semibold flex items-center justify-center gap-2 shadow-sm">
      ...
      <div className="flex flex-nowrap overflow-x-auto justify-start lg:justify-center items-center gap-6 sm:gap-8 md:gap-12 border-t border-slate-200/60 dark:border-slate-800/60 pt-8 pb-4 w-full max-w-full px-4 lg:px-0 no-scrollbar">
        <div className="text-center group shrink-0">
          <div className="text-3xl font-black text-slate-900 dark:text-slate-50 flex items-center justify-center gap-1.5 transition-transform duration-300 group-hover:scale-105">
            <Bot className="w-5 h-5 text-indigo-500" />
            <span>5</span>
          </div>
          <div className="text-[10px] text-slate-500 dark:text-slate-450 font-bold uppercase tracking-wider mt-1">Active Hiring Agents</div>
        </div>
        ...
        <div className="text-center group shrink-0">
          ...
          <div className="text-[10px] text-slate-500 dark:text-slate-450 font-bold uppercase tracking-wider mt-1">Orchestration Speed</div>
        </div>
        <div className="h-8 w-px bg-slate-200/60 dark:bg-slate-800/60 shrink-0" />
        ...
        <div className="text-center group shrink-0">
          ...
          <div className="text-[10px] text-slate-500 dark:text-slate-450 font-bold uppercase tracking-wider mt-1">Matching Accuracy</div>
        </div>
        <div className="h-8 w-px bg-slate-200/60 dark:bg-slate-800/60 shrink-0" />
        ...
        <div className="text-center group shrink-0">
          ...
          <div className="text-[10px] text-slate-500 dark:text-slate-450 font-bold uppercase tracking-wider mt-1">Time Saved</div>
        </div>
        <div className="h-8 w-px bg-slate-200/60 dark:bg-slate-800/60 shrink-0" />
        ...
        <div className="text-center group shrink-0">
          ...
          <div className="text-[10px] text-slate-500 dark:text-slate-450 font-bold uppercase tracking-wider mt-1">Human Power Saved</div>
        </div>
      </div>
    </section>
  );
