...
export function OperatingSystem() {
  return (
    <section className="py-28 px-6 max-w-5xl mx-auto text-center">
      <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900/50 shadow-md mb-8">
        <Sparkles className="w-6 h-6 text-indigo-600 dark:text-indigo-400" />
      </div>
      <h2 className="text-3xl sm:text-4xl font-semibold text-slate-900 dark:text-slate-50 mb-4 tracking-tight transition-colors duration-300">The Operating System for Recruitment.</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 text-left">
        <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 hover:border-indigo-200 dark:hover:border-indigo-900/50 shadow-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 rounded-xl p-8">
          <h4 className="text-slate-955 dark:text-slate-50 font-semibold text-base mb-3 flex items-center gap-2 transition-colors duration-300">
