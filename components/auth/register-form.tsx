        ...
        <div className="p-6 sm:p-7 flex flex-col gap-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button
              type="button"
              disabled
              className="flex items-center justify-center gap-2 border border-slate-200/80 dark:border-slate-800/80 h-[44px] rounded-sm text-xs font-bold text-slate-700 dark:text-slate-300 bg-white dark:bg-[#121320] transition-all duration-300 w-full opacity-50 cursor-not-allowed"
            >
