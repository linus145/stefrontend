        ...
        <div className="px-4 sm:px-6 py-3 sm:py-4 bg-muted/10 border-t border-border flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="w-10 h-10 flex items-center justify-center rounded-md bg-muted/40 text-emerald-500 hover:bg-emerald-500/10 transition-all active:scale-90"
              title="Add Video"
            >
            ...
            <button
              ...
              className="w-10 h-10 flex items-center justify-center rounded-md bg-muted/40 text-[#b49cf8] hover:bg-[#b49cf8]/10 transition-all active:scale-90"
              title="Schedule"
            >
