          ...
          colGoals.map((g: any) => {
            return (
              <div key={g.id} className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800/80 rounded-sm shadow-sm hover:shadow-md transition-all group flex flex-col gap-3">
                ...
                <div className="space-y-1.5 pt-2.5 border-t border-slate-100 dark:border-slate-800/50">
                ...
                <div className="flex items-center justify-between pt-1 text-xs font-semibold text-slate-400">
                  ...
                  <button
                    ...
                    className="w-8 h-8 flex items-center justify-center rounded-sm bg-blue-500/5 text-blue-600 hover:bg-blue-600 hover:text-white border border-blue-500/10 transition-all cursor-pointer"
