    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <form onSubmit={handleSave} className="space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* LLM Engine Config */}
          <Card className="lg:col-span-2 bg-white dark:bg-[#121320] border border-slate-150 dark:border-slate-800 shadow-sm rounded-[3px] overflow-hidden">
            <CardHeader className="p-4 border-b border-slate-100 dark:border-slate-800 flex flex-row items-center justify-between">
              ...
              <Badge className="bg-[#0a66c2]/10 text-[#0a66c2] border-none font-bold text-[9px] px-2 py-0.5 rounded-[3px]">
                Active Engine
              </Badge>
            </CardHeader>
            <CardContent className="p-5 space-y-4">
              ...
              <div className="space-y-1.5 pt-2">
                ...
                <textarea
                  ...
                  className="w-full p-3 text-xs bg-slate-50 dark:bg-[#1c1d30] border border-slate-200 dark:border-slate-850 rounded-[3px] font-medium focus:outline-none focus:border-[#0a66c2] resize-none"
                />
              </div>
            </CardContent>
          </Card>
          ...
          {/* Sidebar Guidelines */}
          <Card className="bg-slate-50 dark:bg-[#151628]/40 border border-slate-150 dark:border-slate-800 rounded-[3px] shadow-sm">
            ...
            <CardContent className="p-4 pt-0 space-y-4">
              ...
              <div className="pt-2 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs">
                ...
                <Badge className="bg-emerald-500/10 text-emerald-600 border-none font-black text-[9px] px-2 py-0.5 rounded-[3px]">
                  ENCRYPTED
                </Badge>
              </div>
            </CardContent>
