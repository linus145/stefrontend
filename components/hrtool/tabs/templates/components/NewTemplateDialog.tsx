    ...
    <div className="fixed inset-0 bg-slate-900/60 dark:bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-[#121320] border border-slate-100 dark:border-slate-800 rounded-md w-full max-w-2xl shadow-2xl p-6 relative animate-in fade-in zoom-in-95 duration-300">
        ...
        <h3 className="text-sm font-extrabold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
          <Plus className="h-5 w-5 text-[#0a66c2]" /> Create Custom Document Template
        </h3>
        <p className="text-xs text-slate-505 mb-5">Draft customized letters, vouchers, and statements using key markdown bindings like <code>{"{{employee_name}}"}</code>.</p>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="e.g. Standard Paid Internship Offer"
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              placeholder="Draft your layout here using standard markdown..."
              rows={10}
