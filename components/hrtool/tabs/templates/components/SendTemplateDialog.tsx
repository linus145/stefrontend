...
export function SendTemplateDialog({
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 dark:bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-[#121320] border border-slate-100 dark:border-slate-800 rounded-md w-full max-w-5xl shadow-2xl p-6 relative flex flex-col md:flex-row gap-6 max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-300">
        <button
          onClick={onClose}
                ...
                <div className="grid grid-cols-2 gap-2">
                  {DESIGN_THEMES.map((theme) => (
                    <button
                      ...
                      className={`relative text-left p-2.5 rounded-lg border-2 transition-all duration-200 cursor-pointer group ${
        ...
        <div className="w-full md:w-1/2 flex flex-col bg-slate-50 dark:bg-[#151624]/60 border border-slate-150 dark:border-slate-850 rounded-md p-6 max-h-[80vh]">
          <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800/80 mb-4">
            ...
            <div className="flex items-center gap-2">
              {selectedEmployeeId && (
                <Badge className="bg-emerald-50 text-emerald-700 border border-emerald-200/50 shadow-none text-[9px] rounded-md font-bold px-2 py-0.5">
                  Target Verified
                </Badge>
              )}
              <Badge className="bg-violet-50 dark:bg-violet-950/30 text-violet-600 dark:text-violet-400 border border-violet-200/50 dark:border-violet-800/40 shadow-none text-[8px] rounded-md font-bold px-2 py-0.5">
