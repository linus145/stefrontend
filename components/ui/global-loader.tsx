      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative h-16 w-16 mb-8">
          ...
          <div className="absolute inset-[2px] rounded-2xl bg-background flex items-center justify-center">
            <div className="h-6 w-6 rounded-lg bg-gradient-to-tr from-primary/80 to-primary shadow-lg shadow-primary/50 animate-bounce"></div>
          </div>
        </div>
        ...
        <div className="space-y-4 text-center">
          ...
          <p className="text-[10px] uppercase font-bold tracking-[0.3em] text-muted-foreground animate-fade-in-out">
